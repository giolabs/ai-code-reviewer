 ...
 * lo usa directamente.
 */
export function findConfigFile(explicitPath, cwd = process.cwd()) {
    if (explicitPath) {
 ...
 */
export function loadRulesFile(rulesPath, cwd = process.cwd()) {
    if (!rulesPath)
        return null;
 ...
 */
export function loadBuiltinTemplate(tech) {
 ...
 */
export function filterIgnored(paths, ignorePatterns) {
