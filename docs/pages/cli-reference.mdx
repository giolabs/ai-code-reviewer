...
Handles developer replies to inline bot comments (`/explain`, `/dismiss`). Must run inside a GitHub Actions environment triggered by `pull_request_review_comment`.
